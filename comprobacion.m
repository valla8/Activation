...
Comp_PMMA= [0.596109   0.0 0  0.333583 0 0];
...
figure
hold off
plot(PG_N14_N14_1_E,PG_N14_N14_1_CS,'go'); hold on
...
plot(Eval,PG_N14_N14_1_F(Eval),'c-')
axis([0 300 0 1.0]);
xlabel('Proton energy (MeV)')
ylabel('Cross section (barn)')
...
figure
hold off
plot(PG_N14_N14_2_E,PG_N14_N14_2_CS,'go'); hold on
...
plot(Eval,PG_N14_N14_2_F(Eval),'c-')
axis([0 300 0 0.2]);
xlabel('Proton energy (MeV)')
ylabel('Cross section (barn)')
...
PG_O16_O16_6_F = fit(PG_O16_O16_6_E,PG_O16_O16_6_CS,'smoothingspline','SmoothingParam',0.999)
...
%% PG 16O-12C 4.4 MeV
 hold on
plot(PG_O16_C12_4_E,PG_O16_C12_4_CS,'go');
PG_O16_C12_4_F = fit(PG_O16_C12_4_E,PG_O16_C12_4_CS,'smoothingspline','SmoothingParam',0.1)
PG_O16_C12_4_F.p.coefs(1,:) = [0 0 0 0];
PG_O16_C12_4_F.p.coefs(end,:) = [0 0 0 0];
plot(Eval,PG_O16_C12_4_F(Eval),'c-')
axis([0 300 0 0.2]);
xlabel('Proton energy (MeV)')
ylabel('Cross section (barn)')
...
SPECTR=[1.63 2.31 4.44 6.13];
CUENT=[sum(Y_1t) sum(Y_2t) sum(Y_4t) sum(Y_6t)];
plot(SPECTR,CUENT,'bo');
